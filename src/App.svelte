      ...
      <div class="space-y-4">
        <details class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-md">
          <summary class="font-semibold cursor-pointer text-sakura-pink dark:text-sakura-light">
            เวอเดิ้ลภาษาไทย หรือ เวอเดิล แตกต่างจาก Wordle อย่างไร?
          </summary>
          <p class="mt-3 text-sm">
            <strong>เวอเดิ้ลภาษาไทย (Thwordle)</strong> เป็นเวอร์ชันภาษาไทยของ Wordle ที่ใช้คำศัพท์ภาษาไทย รองรับการใช้สระและวรรณยุกต์ภาษาไทย มีระบบคีย์บอร์ดพิเศษสำหรับ <strong>เวอเดิลไทย</strong>
          </p>
        </details>
        <details class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-md">
